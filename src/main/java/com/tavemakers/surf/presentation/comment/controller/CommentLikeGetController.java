...
import com.tavemakers.surf.application.comment.query.CommentLikeGetService;
...
public class CommentLikeGetController {
    ...
    private final CommentLikeGetService commentLikeGetService;
    ...
    public ApiResponse<Long> getLikeCount(@PathVariable Long commentId) {
        long count = commentLikeGetService.countLikes(commentId);
    ...
    public ApiResponse<Boolean> isLiked(@PathVariable Long commentId) {
        ...
        boolean liked = commentLikeGetService.isLikedByMe(commentId, memberId);
    ...
    public ApiResponse<List<CommentLikeMemberResDTO>> getLikedMembers(@PathVariable Long commentId) {
        List<CommentLikeMemberResDTO> likedMembers = commentLikeGetService.getMembersWhoLiked(commentId);
