...
public class BadgeUpdateService {
    ...
    /** 배지 정보 수정 */
    public void updateBadge(Long badgeId, String name, String imageUrl, String description, String requirement) {
        ...
        // 원시값으로 배지 필드 업데이트
        badge.update(name, imageUrl, description, requirement);
    }
}