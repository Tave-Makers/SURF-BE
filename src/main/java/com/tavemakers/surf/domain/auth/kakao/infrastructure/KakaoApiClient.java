package com.tavemakers.surf.domain.auth.kakao.infrastructure;

import com.tavemakers.surf.domain.auth.common.presentation.dto.OAuthUserInfoDTO;
import com.tavemakers.surf.domain.auth.common.domain.service.OAuthApiClient;
import com.tavemakers.surf.domain.auth.kakao.infrastructure.config.KakaoOAuthProps;
import com.tavemakers.surf.domain.auth.kakao.presentation.dto.KakaoTokenResDTO;
import com.tavemakers.surf.domain.auth.kakao.presentation.dto.KakaoUserInfoDTO;
import com.tavemakers.surf.domain.auth.kakao.domain.exception.KakaoAuthErrorMessage;
import com.tavemakers.surf.domain.auth.kakao.domain.exception.KakaoAuthException;
