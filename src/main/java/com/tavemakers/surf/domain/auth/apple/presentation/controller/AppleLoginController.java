package com.tavemakers.surf.domain.auth.apple.presentation.controller;

import com.tavemakers.surf.domain.auth.apple.presentation.dto.AppleAppLoginReqDTO;
import com.tavemakers.surf.domain.auth.apple.domain.exception.AppleAuthErrorMessage;
import com.tavemakers.surf.domain.auth.apple.domain.exception.AppleAuthException;
import com.tavemakers.surf.domain.auth.apple.domain.service.AppleAuthService;
import com.tavemakers.surf.domain.auth.apple.domain.service.AppleOAuthStateService;
import com.tavemakers.surf.domain.auth.apple.application.usecase.AppleLoginUsecase;
import com.tavemakers.surf.domain.auth.common.presentation.dto.ClientType;
