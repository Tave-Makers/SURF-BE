...
public enum ActivityType {
    ...
    STUDY_LATE_6_TO_10("스터디 지각", -5, PENALTY, INDIVIDUAL),
    STUDY_LATE_11_TO_20("스터디 지각", -10, PENALTY, INDIVIDUAL),
    STUDY_LATE_21_TO_30("스터디 지각", -15, PENALTY, INDIVIDUAL),
    STUDY_ABSENCE("스터디 결석", -30, PENALTY, INDIVIDUAL),

    PROJECT_LATE_6_TO_10("프로젝트 지각", -5, PENALTY, INDIVIDUAL),
    PROJECT_LATE_11_TO_20("프로젝트 지각", -10, PENALTY, INDIVIDUAL),
    PROJECT_LATE_21_TO_30("프로젝트 지각", -15, PENALTY,INDIVIDUAL),
