package com.tavemakers.surf.domain.activity.domain.entity.enums;

import com.tavemakers.surf.domain.activity.presentation.dto.activityRecord.response.ActivityCategoryDetailResDTO;
import com.tavemakers.surf.domain.activity.presentation.dto.activityRecord.response.ActivityTypeDetailResDTO;
...
import static com.tavemakers.surf.domain.activity.domain.entity.enums.ActivityCategory.*;
import static com.tavemakers.surf.domain.activity.domain.entity.enums.AppliedTarget.INDIVIDUAL;
import static com.tavemakers.surf.domain.activity.domain.entity.enums.AppliedTarget.TEAM;
import static com.tavemakers.surf.domain.activity.domain.entity.enums.ScoreType.*;
