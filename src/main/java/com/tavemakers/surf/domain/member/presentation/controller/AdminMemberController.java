...
import com.tavemakers.surf.domain.member.presentation.dto.request.RoleChangeReqDTO;
import com.tavemakers.surf.domain.member.presentation.dto.request.RoleChangeReqDTOV2;
import com.tavemakers.surf.domain.member.presentation.dto.response.ApprovedMemberSliceResDTO;
import com.tavemakers.surf.domain.member.presentation.dto.response.MemberInformationResDTO;
import com.tavemakers.surf.domain.member.presentation.dto.response.MemberRegistrationSliceResDTO;
import com.tavemakers.surf.domain.member.application.usecase.MemberAdminUsecase;
...
import static com.tavemakers.surf.domain.member.presentation.controller.ResponseMessage.*;
