...
public interface MemberRepository extends JpaRepository<Member, Long> {
    ...
    @Query("""
        ...
        where m.activityStatus = true
          and m.status = com.tavemakers.surf.domain.member.domain.entity.enums.MemberStatus.APPROVED
    """)
    ...
    @Query("""
        ...
        from Member m
        left join fetch m.tracks
        where m.status = com.tavemakers.surf.domain.member.domain.entity.enums.MemberStatus.APPROVED
          and m.isDeleted = false
    """)
